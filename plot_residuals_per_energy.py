...
def main():
    ...
    ap.add_argument("--last", type=int, default=5, help="Use last N epochs (default 5)")
    ap.add_argument("--bins", type=int, default=40, help="Histogram bins")
    ap.add_argument("--min-count", type=int, default=20, help="Skip energies with too few points")
