#!/bin/bash
#SBATCH -J "mass_tensorMaker_7.sh"
#SBATCH -N 1
...
while squeue -u "$USER" | grep -q "batch_wo"; do
  ...
  if [ ! -f "start_tensorMaker_7.txt" ]; then
    sleep 1
  else
    ...
    rm -rf mc_Simulation_run0_7_Test_1evt_${particle}_${energy}_${energy}.root

    mv tensor_${group}_7_${particle}_${energy}/npy/* tensfold/tensor_7_${particle}_${energy}_${group}_${SPAD_Size}.npy
    rm -rf tensor_${group}_7_${particle}_${energy}
